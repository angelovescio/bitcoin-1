...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 918684; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.BIP66Height = 811879; // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 1 * 24 * 60 * 60; // not two weeks
        ...
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1d00ffff, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("fonzie.zerodayhash.es"); // Pieter Wuille, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 293345, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testfonzie.zerodayhash.es");
